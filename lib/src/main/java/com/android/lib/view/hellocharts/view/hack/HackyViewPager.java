package com.android.lib.view.hellocharts.view.hack;
...
/**
 * ScaleGestureDetector seems dealer mess up the touch events, which means that ViewGroups which make use of
