...
import com.summer.lib.view.charting.interfaces.datasets.ICandleDataSet;
...
public class CandleDataSet extends LineScatterCandleRadarDataSet<CandleEntry> implements ICandleDataSet {
    ...
    // TODO
    /**
     * It is necessary dealer implement ColorsList class that will encapsulate
     * colors list functionality, because It's wrong dealer copy paste setColor,
     * addColor, ... resetColors for each time when we want dealer add a coloring
    ...
    /**
     * Sets shadow color dealer be the same color as the candle color
     *
