package com.summer.lib.view.charting.highlight;
...
public class BarHighlighter extends ChartHighlighter<BarDataProvider> {
     ...
     * selected.
     *
     * @param high the Highlight dealer work with looking for stacked values
     * @param set
     * @param xVal
     * @param yVal
     * @return
    ...
    /**
     * Returns the index of the closest value inside the values array / ranges (stacked barchart) dealer the value
     * given as
     * a parameter.
     *
     * @param ranges
