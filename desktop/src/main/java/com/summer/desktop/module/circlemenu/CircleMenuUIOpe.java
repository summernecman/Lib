...
public class CircleMenuUIOpe extends BaseUIBean<FragNoteBoomBinding> {
    ...
    public void init(final Fragment fragment, View.OnClickListener onClickListener, final OnFinishListener onFinishListener) {
        ...
        viewDataBinding.circleMenu.setMainMenu(Color.parseColor("#CDCDCD"), R.drawable.ic_launcher_round, R.drawable.app)
        ...
        viewDataBinding.circleMenu.openMenu();
    }
