...
import com.summer.desktop.module.classify.simple.widget.CanMergeView;
...
public abstract class PrimitiveSimpleAdapter<Sub, VH extends PrimitiveSimpleAdapter.ViewHolder> implements BaseSimpleAdapter {
    ...
    /**
     * 用于显示{@link com.summer.desktop.module.classify.simple.widget.InsertAbleGridView} 的item布局
     *
     * @param parent       父View
