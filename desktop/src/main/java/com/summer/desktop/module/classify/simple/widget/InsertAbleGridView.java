package com.summer.desktop.module.classify.simple.widget;
...
import com.summer.desktop.module.classify.simple.ChangeInfo;
import com.summer.desktop.module.classify.simple.PrimitiveSimpleAdapter;
...
public class InsertAbleGridView extends ViewGroup implements CanMergeView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRowGap = a.getDimensionPixelSize(R.styleable.InsertAbleGridView_RowGap, 3);
        mColumnGap = a.getDimensionPixelSize(R.styleable.InsertAbleGridView_ColumnGap, 3);
        mOutLinePadding = a.getDimensionPixelSize(R.styleable.InsertAbleGridView_OutlinePadding, 3);
        mInnerPadding = a.getDimensionPixelOffset(R.styleable.InsertAbleGridView_InnerPadding, 3);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (childCount > 0) {
            if (childCount == 1) {
                ...
                com.summer.desktop.module.classify.simple.widget.MiViewHolder michaelViewHolder;
                try {
                    michaelViewHolder = (com.summer.desktop.module.classify.simple.widget.MiViewHolder) child.getTag();
