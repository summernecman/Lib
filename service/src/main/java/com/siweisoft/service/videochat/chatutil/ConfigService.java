...
public class ConfigService {
    public static VideoValue.ConfigEntity LoadConfig(Context context) {
        VideoValue.ConfigEntity configEntity = new VideoValue.ConfigEntity();
        ...
        configEntity.mConfigMode = sharedPreferences.getInt("ConfigMode", VideoValue.ConfigEntity.VIDEO_MODE_CUSTOMCONFIG);
        ...
        configEntity.mVideoQuality = sharedPreferences.getInt("VideoQuality", VideoValue.ConfigEntity.VIDEO_QUALITY_GOOD);
    ...
    public static void SaveConfig(Context context, VideoValue.ConfigEntity configEntity) {
        SharedPreferences sharedPreferences;
        int currentapiVersion = android.os.Build.VERSION.SDK_INT;
        if (currentapiVersion >= 24) {
            sharedPreferences = context.getSharedPreferences(
